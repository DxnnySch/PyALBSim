...
class World:
    def __init__(self, laser_settings: Laser, camera_settings: Camera, absorption_coefficient = 0.169, total_scattering_coefficient = 1.21, salinity_unit = 37, seafloor_albedo = 0.05, water_surface_roughness = 0.035, water_surface_albedo = 0.1):
        ...
        self.absorption_coefficient = absorption_coefficient; # total absorption coefficient in water. m-1.
        self.total_scattering_coefficient = total_scattering_coefficient#1.21; # total scattering coefficient
        self.salinity_unit = salinity_unit; # salinity unit. The salt content in pure seawater. S is generally 37 ppt (Pure water is 0 ppt).
        ...
        self.seafloor_albedo = seafloor_albedo # how much energy is reflected of the sea floor (how much is not absorbed)
        self.water_surface_roughness = water_surface_roughness # alpha parameter for microfacet brdf
        self.water_surface_albedo = water_surface_albedo # how much energy is reflected of the water surface
