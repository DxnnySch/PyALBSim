# Source: https://github.com/rafael-fuente/Python-Raytracer/blob/master/sightpy/utils/vector3.py
import numpy as np
import numbers
...
class vec3():
    def __init__(self, x: numbers.Number | np.ndarray, y: numbers.Number | np.ndarray, z: numbers.Number | np.ndarray):
        self.x = x
        self.y = y
        self.z = z
